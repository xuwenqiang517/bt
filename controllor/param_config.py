...
class ParamRanges:
    ...
    buy_day3_min_range: List[int] = field(default_factory=lambda: [-1] + r(8, 15, 3))  # 3日涨幅下限%: -1(不限制), 3,5,7,9,11,13,15%
    buy_day3_max_range: List[int] = field(default_factory=lambda: [-1] + r(10, 30, 3))  # 3日涨幅上限%: -1(不限制), 10,12,14...30%
    buy_day5_min_range: List[int] = field(default_factory=lambda: [-1] )  # 5日涨幅下限%: -1(不限制), 5,7,9...25%
    buy_day5_max_range: List[int] = field(default_factory=lambda: [-1] + r(15, 30, 3))  # 5日涨幅上限%: -1(不限制), 15,17,19...40%
    ...
    sell_hold_days_range: List[int] = field(default_factory=lambda: r(4, 6))  # 持仓天数: 3-15天
    sell_target_return_range: List[int] = field(default_factory=lambda: r(4, 10, 2))  # 目标涨幅%: 5,7,9...20%
    sell_trailing_range: List[int] = field(default_factory=lambda: r(2, 6, 2))  # 回撤止盈率%: 2,4,6...20%
